...
public class BarDataSetWithSpace extends BarLineScatterCandleBubbleDataSet<BarEntry> implements IBarDataSet {

    /**
     * space indicator between the bars 0.1f == 10 %
     */
    private float mBarSpace = 0.3f;
    ...
    public BarDataSetWithSpace(List<BarEntry> yVals, String label) {
        super(yVals, label);
    ...
    public DataSet<BarEntry> copy() {
        ...
        BarDataSetWithSpace copied = new BarDataSetWithSpace(yVals, getLabel());
