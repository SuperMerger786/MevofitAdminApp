...
public class VerticalLabelView extends View {
    ...
    public VerticalLabelView(Context context, AttributeSet attrs) {
        ...
        CharSequence s = a.getString(R.styleable.VerticalLabelView_text_v);
        if (s != null) setText(s.toString());

        setTextColor(a.getColor(R.styleable.VerticalLabelView_textColor_v, 0xFF000000));

        int textSize = a.getDimensionPixelOffset(R.styleable.VerticalLabelView_textSize_v, 0);
