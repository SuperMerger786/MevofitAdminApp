...
public class ShimmerLayoutAdmin extends FrameLayout {
    ...
    public ShimmerLayoutAdmin(Context context) {
        this(context, null);
    }

    public ShimmerLayoutAdmin(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShimmerLayoutAdmin(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            shimmerColor = a.getColor(R.styleable.ShimmerLayout_shimmer_color, Color.parseColor("#ebebeb"));
     ...
     * 0.99 means that the whole shimmer line will have this color with a little transparent_booing edges.
