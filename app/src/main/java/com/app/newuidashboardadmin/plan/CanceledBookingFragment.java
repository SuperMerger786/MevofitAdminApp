...
public class CanceledBookingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.canceled_booking_slot_fragment, container, false);
    ...
    private void fetchData(String slotdate) {
        ...
        RestApiController restApiController = new RestApiController(getContext(), new Response() {
            ...
            public void onResponseObtained(Object response, int responseType, boolean isCachedData) {
                ...
                if (bookingHistoryResponse != null && bookingHistoryResponse.sectionDataArrayList != null) {
                    CompleteSectionListAdapter sectionListAdapter = new CompleteSectionListAdapter(bookingHistoryResponse.sectionDataArrayList, getContext(),"cancelled");
        ...
        CompletedBookingSlotsRequest getSellerBookingSlotsRequest = new CompletedBookingSlotsRequest("canceled",getContext(), slotdate);
